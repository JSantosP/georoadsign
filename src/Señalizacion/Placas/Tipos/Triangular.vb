...
Public Class Triangular
    ...
    'Atributos
    Shared ReadOnly ESQUEMA_XML As String = My.Resources.XML_SCHEME_TRIANGULAR
    ...
    Public Sub New(ByVal posicion As Punto3D, _
        ...
        Dim ahora = Now
        With Now
            Me.identificador = "triangular" & .Year & .Month & .Day & .Hour & .Minute & .Second & .Millisecond
        End With
    End Sub
    'Resto de Subprogramas
    Public Overrides Sub GenerarPlaca()
        Dim XML As String = Triangular.ESQUEMA_XML
