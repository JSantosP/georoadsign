...
Public Class Circular
    ...
    'Atributos
    Shared ReadOnly ESQUEMA_XML As String = My.Resources.XML_SCHEME_CIRCULAR
    ...
    Public Sub New(ByVal posicion As Punto3D, _
        ...
        Dim ahora = Now
        With Now
            Me.identificador = "circular" & .Year & .Month & .Day & .Hour & .Minute & .Second & .Millisecond
        End With
    End Sub
    'Resto de Subprogramas
    Public Overrides Sub GenerarPlaca()
        Dim XML As String = Circular.ESQUEMA_XML
